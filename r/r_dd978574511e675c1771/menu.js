...
function show(lang,navigate=true){
 ...
 if(['kg','100g','each'].includes(item.price_unit)&&item.price_minor!==null){const unit=document.createElement('small');unit.textContent='/ '+(item.price_unit==='each'?t.each:item.price_unit);price.append(unit)}
